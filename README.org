...
By default consult-omni provides two main multi-source inteactive commands.
...
Furthermore I would like to thank [[https://github.com/karthink][@karthink]], and [[https://github.com/armindarvish/consult-omni][@minad]] for their fabulous suggestions, discussions, contributions, ... in reddit as well as on consult-web repo. This package would not have been possible without [[https://github.com/karthink][@karthink]]'s help in prototyping and ideation and [[https://github.com/armindarvish/consult-omni][@minad]]'s precious comments and suggestions
